 ...
 * `src/v1beta1/session_service_client_config.json`.
...
class SessionServiceClient {
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('aiplatform');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            exampleStorePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/exampleStores/{example_store}'),
            ...
            extensionPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/extensions/{extension}'),
            ...
            featureMonitorPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/featureGroups/{feature_group}/featureMonitors/{feature_monitor}'),
            featureMonitorJobPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/featureGroups/{feature_group}/featureMonitors/{feature_monitor}/featureMonitorJobs/{feature_monitor_job}'),
            ...
            memoryPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/reasoningEngines/{reasoning_engine}/memories/{memory}'),
            ...
            modelMonitorPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/modelMonitors/{model_monitor}'),
            modelMonitoringJobPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/modelMonitors/{model_monitor}/modelMonitoringJobs/{model_monitoring_job}'),
            ...
            projectLocationFeatureGroupFeaturesPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/featureGroups/{feature_group}/features/{feature}'),
            projectLocationFeaturestoreEntityTypeFeaturesPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entity_type}/features/{feature}'),
            ...
            ragEngineConfigPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/ragEngineConfig'),
            ...
            sessionPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/reasoningEngines/{reasoning_engine}/sessions/{session}'),
            sessionEventPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/reasoningEngines/{reasoning_engine}/sessions/{session}/events/{event}'),
        ...
        this.descriptors.page = {
            ...
            listEvents: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'sessionEvents')
        };
        ...
        const createSessionResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.Session');
        const createSessionMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CreateSessionOperationMetadata');
        const deleteSessionResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteSessionMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        this.descriptors.longrunning = {
            createSession: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createSessionResponse.decode.bind(createSessionResponse), createSessionMetadata.decode.bind(createSessionMetadata)),
            deleteSession: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteSessionResponse.decode.bind(deleteSessionResponse), deleteSessionMetadata.decode.bind(deleteSessionMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.SessionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.sessionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.aiplatform.v1beta1.SessionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.aiplatform.v1beta1.SessionService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const sessionServiceStubMethods = ['createSession', 'getSession', 'listSessions', 'updateSession', 'deleteSession', 'listEvents', 'appendEvent'];
    ...
    appendEvent(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize().catch(err => { throw err; });
        this._log.info('appendEvent request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('appendEvent response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.appendEvent(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('appendEvent response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
     ...
     * @example <caption>include:samples/generated/v1beta1/session_service.create_session.js</caption>
     * region_tag:aiplatform_v1beta1_generated_SessionService_CreateSession_async
     */
    async checkCreateSessionProgress(name) {
     ...
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta1/session_service.delete_session.js</caption>
     * region_tag:aiplatform_v1beta1_generated_SessionService_DeleteSession_async
     */
    async checkDeleteSessionProgress(name) {
     ...
     *   Optional. The
     *   {@link protos.google.cloud.aiplatform.v1beta1.ListSessionsResponse.next_page_token|next_page_token}
     *   value returned from a previous list
     *   {@link protos.google.cloud.aiplatform.v1beta1.SessionService.ListSessions|SessionService.ListSessions}
     *   call.
     ...
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.aiplatform.v1beta1.Session|Session} on 'data' event.
     ...
     *   {@link protos.google.cloud.aiplatform.v1beta1.Session|Session}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta1/session_service.list_sessions.js</caption>
     * region_tag:aiplatform_v1beta1_generated_SessionService_ListSessions_async
     */
    ...
    listEvents(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     * @param {string} [request.pageToken]
     *   Optional. The
     *   {@link protos.google.cloud.aiplatform.v1beta1.ListEventsResponse.next_page_token|next_page_token}
     *   value returned from a previous list
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.aiplatform.v1beta1.SessionEvent|SessionEvent} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     *   times as needed. Note that it can affect your quota.
    ...
    listEventsStream(request, options) {
        ...
        return this.descriptors.page.listEvents.createStream(this.innerApiCalls.listEvents, request, callSettings);
    }
    /**
     ...
     *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
     *   When you iterate the returned iterable, each element will be an object representing
     *   {@link protos.google.cloud.aiplatform.v1beta1.SessionEvent|SessionEvent}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta1/session_service.list_events.js</caption>
     * region_tag:aiplatform_v1beta1_generated_SessionService_ListEvents_async
     */
    listEventsAsync(request, options) {
        ...
        return this.descriptors.page.listEvents.asyncIterate(this.innerApiCalls['listEvents'], request, callSettings);
    }
    /**
