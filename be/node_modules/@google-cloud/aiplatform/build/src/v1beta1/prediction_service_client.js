...
class PredictionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.stream = {
            ...
            chatCompletions: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.SERVER_STREAMING, !!opts.fallback, !!opts.gaxServerStreamingRetries)
        };
    ...
    initialize() {
        ...
        this.predictionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            ...
            this._protos.google.cloud.aiplatform.v1beta1.PredictionService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const predictionServiceStubMethods = ['predict', 'rawPredict', 'streamRawPredict', 'directPredict', 'directRawPredict', 'streamDirectPredict', 'streamDirectRawPredict', 'streamingPredict', 'serverStreamingPredict', 'streamingRawPredict', 'explain', 'countTokens', 'generateContent', 'streamGenerateContent', 'chatCompletions', 'embedContent'];
    ...
    rawPredict(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.rawPredict(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('rawPredict response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    directPredict(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.directPredict(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('directPredict response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    directRawPredict(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.directRawPredict(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('directRawPredict response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    explain(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.explain(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('explain response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    chatCompletions(request, options) {
        ...
        this.initialize().catch(err => { throw err; });
        this._log.info('chatCompletions stream %j', options);
