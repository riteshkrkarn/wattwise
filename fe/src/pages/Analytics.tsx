          ...
          <div className="chart-container" style={{ height: '300px' }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={consumptionData}>
                <CartesianGrid strokeDasharray="3 3" stroke="rgba(122, 140, 160, 0.1)" vertical={false} />
                <XAxis 
                  dataKey="month" 
                ...
                <YAxis 
                  ...
                  axisLine={false}
                  tickLine={false}
                  label={{ value: 'kWh', angle: -90, position: 'insideLeft', fill: '#7a8ca0' }}
                />
                <Tooltip 
                  contentStyle={{
                ...
                />
                <Bar dataKey="consumption" fill="var(--accent-purple)" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
              ...
              {costBreakdown.map((item, index) => (
                <div key={item.name} className="breakdown-item">
                  <div className="breakdown-label">
                    <div className="breakdown-color" style={{ backgroundColor: COLORS[index] }}></div>
                    <span>{item.name}</span>
                  </div>
